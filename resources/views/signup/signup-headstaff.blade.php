    ...
    <section>
        <div class="form-box signup  lg-5">
            <div class="form-value">
                <form action="{{ route('signupheadStaff') }}" method="post">
                    @csrf
                    <h2>SignUp</h2>
                    <div class="input-box">
                        <i class='bx bxs-user'></i>
                        <input type="text" name="name" @error('name') is-invalid @enderror required value="{{ old('name') }}">
                    ...
                    <div class="input-box">
                        ...
                        <input type="password" name="password" id="password" @error('password') is-invalid @enderror required>
