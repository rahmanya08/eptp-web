...
<main>
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="active" href="{{ route('staffSaveUp') }}">Profile</a>
                </li>
            </ul>
        </div>
    </div>
    @if (session()->has('success'))
        <div class="alert alrt-success" role="alert" id="alert">
            {{ session('success') }}
            <i class='bx bx-x' id="icon" onclick="hideAlert()" style="cursor: pointer"></i>
        </div>
    @endif
        <form action="{{ route('staffSaveUp') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row-from">
                ...
                <div class="column right">
                    ...
                    <div class="row-right">
                        <div class="input-warp">
                            ...
                            @else
                                <input readonly type="text" name="position"  id="position" value="Staff">
                            @endif 
                        </div>
                    </div> 
                        <div class="row-right">
